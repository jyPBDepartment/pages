...
<template>
  <div>
    ...
    >
      ...
      <el-table-column sortable prop="name" label="名称" width="200" show-overflow-tooltip></el-table-column>
      <el-table-column sortable prop="payType" label="支付类型" width="120" show-overflow-tooltip></el-table-column>
      <el-table-column sortable prop="partner" label="商户号" width="100" show-overflow-tooltip></el-table-column>
      <el-table-column sortable prop="subMchId" label="微信子商户" width="140" show-overflow-tooltip></el-table-column>
      <el-table-column sortable prop="appid" label="应用ID" width="100" show-overflow-tooltip></el-table-column>
      <el-table-column sortable prop="signType" label="加密类型" width="120" show-overflow-tooltip></el-table-column>
      <el-table-column sortable prop="partnerKey" label="商户签名密钥" width="180" show-overflow-tooltip></el-table-column>
      <el-table-column sortable prop="notifyUrl" label="通知回调" width="140" show-overflow-tooltip></el-table-column>
      <el-table-column sortable prop="sellerUserId" label="支付宝卖家" width="150" show-overflow-tooltip></el-table-column>
      <el-table-column sortable prop="certPath" label="微信证书路径" width="150" show-overflow-tooltip></el-table-column>
    ...
    >
      <el-form label-width="120px" :model="editForm" :rules="rules" ref="editForm">
        ...
        <el-form-item label="微信证书密码" prop="certPassword">
          <el-input
            size="small"
            v-model="editForm.certPassword"
            auto-complete="off"
            placeholder="请输入微信证书密码"
          ></el-input>
        </el-form-item>
        <el-form-item label="支付宝私钥" prop="rsaKey">
          <el-input
            size="small"
            v-model="editForm.rsaKey"
            auto-complete="off"
