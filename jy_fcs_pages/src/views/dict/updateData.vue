    ...
    <slot>
      ...
      >
        <el-form-item label="标签" prop="dictLabel">
          <el-input
            type="text"
            v-model="dataEditForm.dictLabel"
        ...
        <el-form-item label="键值" prop="dictValue">
          <el-input
            type="text"
            v-model="dataEditForm.dictValue"
        ...
        <el-form-item label="排序" prop="dictSort">
          <el-input-number v-model="dataEditForm.dictSort" :step=5 step-strictly></el-input-number>
      </el-form-item>
      </el-form>
    </slot>
    <!-- 按钮区 -->
...
export default {
  ...
  watch: {
    ...
    transDataId(val){
      ...
      api
        .testAxiosGet(ApiPath.url.findDictDataById, params)
        .then((res) => {
          if (res.state == 0) {
            this.dataEditForm = res.data;
          }
        });
    },
  },
  methods: {
    ...
    saveDictType: function () {
      ...
      if (this.dataEditForm.dictLabel != "" ) {
        ...
        api
          .testAxiosGet(ApiPath.url.updateDictData, params)
          .then((res) => {
