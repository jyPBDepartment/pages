...
<template>
  <div class="adminFunction">
    ...
    <el-table :data="tableData" border style="width: 100%;" highlight-current-row size="mini">
      ...
      <el-table-column prop="name" label="证书名称" align="center" min-width="20%"  :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="remark" label="证书描述" align="center" min-width="20%"  :show-overflow-tooltip="true"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    statusEnable: function (scope) {
      ...
      api
        .testAxiosGet(ApiPath.url.changeCertificateStatus, params)
        .then((res) => {
          let code = res.state;
          if (code == "1") {
    ...
    search: function (parameter) {
      ...
      api
        .testAxiosGet(ApiPath.url.findCertificatePage, params)
        .then((res) => {
          let code = res.state;
          if (code == "0") {
