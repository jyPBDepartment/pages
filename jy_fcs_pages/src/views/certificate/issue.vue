  ...
  <div class="adminFunction">
    ...
    <el-form :inline="true" class="demo-form-inline">
      ...
      <el-form-item label="状态">
        <el-select v-model="status" style="width:46%"  size="small" >
          <el-option
    ...
    <el-table :data="tableData" border style="width: 100%;" highlight-current-row size="mini">
      ...
      <el-table-column  label="状态" align="center" min-width="8%">
        <template slot-scope="scope">
          ...
          <el-tag v-if="scope.row.issueState == 1" type="success">已完成</el-tag>
        </template>
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    search: function (parameter) {
      ...
      api
        .testAxiosGet(ApiPath.url.findIssueList, params)
        .then((res) => {
          let code = res.state;
          if (code == "0") {
