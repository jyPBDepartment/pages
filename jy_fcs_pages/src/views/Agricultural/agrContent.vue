<template>
  ...
  >
    <slot>
      ...
      >
        ...
        <!-- <el-form-item label="农服交易类型">
         ...
         <el-radio-group v-model="agrForm.transactionTypeCode" style="padding-bottom:5px;padding-left:98px;margin-top:-84px;" disabled>
      ...
      <!--  <el-form-item label="农服交易类别">
        ...
        <el-radio-group v-model="agrForm.transactionCategoryCode" style="padding-bottom:5px;padding-left:98px;margin-top:-84px;" disabled>
        ...
        <el-radio-group
          v-model="agrForm.status"
          prop="status"
          style="padding-bottom:5px;padding-left:98px;margin-top:-84px;"
        >
          <el-radio label="0" style="padding-bottom:10px">待审核</el-radio>
          <el-radio label="1" style="padding-bottom:10px">审核通过</el-radio>
    ...
    <span slot="footer">
      <el-button icon="el-icon-check" @click="updateStatus()">保存</el-button>
