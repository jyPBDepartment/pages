...
<template>
  <div>
    ...
    <el-table  size="small" :data="listData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column sortable prop="postInfoEntity.name" label="贴子标题" align="center" ></el-table-column>
      <el-table-column sortable prop="commentUserName" label="评论人" align="center" ></el-table-column>
      <el-table-column show-overflow-tooltip sortable prop="commentContent" label="评论内容" align="center" ></el-table-column>
