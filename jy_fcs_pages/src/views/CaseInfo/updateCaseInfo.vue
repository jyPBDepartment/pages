  ...
  >
    ...
    <slot>
      ...
      >
        ...
        <el-form-item label="病虫害种类" prop="classiDipCode">
          <el-select
        ...
        <el-form-item label="图片" prop="describetion">
          <el-upload
            class="upload-demo"
            :action="upload"
        ...
        <el-form-item label="概述" prop="describetion">
        ...
        <el-form-item label="危害" prop="harm">
        ...
        <el-form-item label="传播途径/发病条件" prop="channel">
        ...
        <el-form-item label="防治技术" prop="controlTechnology">
          <div class="edit_containerC">
            <el-card style="height: 250px; width: 560px">
              ...
              <quill-editor
                v-model="caseInfoForm.controlTechnology"
                ref="myQuillEditorC"
                style="height: 145px; margin-top: -40px"
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        harm: [{ required: true, message: "请输入危害", trigger: "blur" }],
        channel: [
          {
            required: true,
            message: "请输入传播途径/发病条件",
            trigger: "blur",
          },
        ],
        controlTechnology: [
  ...
  methods: {
    ...
    updateCaseInfo(editData) {
      this.$refs["caseInfoForm"].validate((valid) => {
        if (valid) {
          if (this.imgUrl == "") {
          ...
          if (this.caseInfoForm.content == "") {
            this.$message.error("内容不能为空！");
            return;
          }
          if (this.caseInfoForm.harm == "") {
            this.$message.error("危害信息不能为空！");
            return;
          }
          if (this.caseInfoForm.channel == "") {
            this.$message.error("传播途径/发病条件信息不能为空！");
            return;
          }
          if (this.caseInfoForm.controlTechnology == "") {
          ...
          if (this.isSelected) {
            this.caseInfoForm.isSelected = 1;
          } else {
            this.caseInfoForm.isSelected = 0;
          }
          let params = {
