...
export default {
  ...
  watch: {
    ...
    //根据Id查询用户信息
    transReplyInfo(val) {
      this.commentInfoForm.title = val[0].row.commentContent;
      this.commentInfoForm.date = val[0].row.replyDate;
      this.commentInfoForm.user = val[0].row.replyUserName;
      this.commentInfoForm.content = val[0].row.replyContent;
    },
  },
  methods: {
    close: function () {
