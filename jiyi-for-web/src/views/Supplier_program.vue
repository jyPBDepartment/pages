<template>
  <div class="Home">
    <img
      class="top_img"
      src="http://60.205.246.126/images/2020/10/20/1603154692063534.jpg"
      style="height: 640px"
    />
    ...
    >
      <div class="w">
        <img
          src="http://60.205.246.126/images/2020/10/20/1603154785939588.gif"
          alt=""
          class="video"
        />
      </div>
    ...
    <Fast :title="modelName[4].title" :id="modelName[4].id">
      <el-row class="sdys">
        ...
        <el-col :span="6">
          <img
            class="sdys_img"
            src="http://60.205.246.126/images/2020/10/20/1603155896383488.jpg"
            alt
          />
        </el-col>
        <el-col class="title" :span="9">
  ...
  data() {
    return {
      ...
      tabPane: [
        {
          src:
            "https://yanxuan.nosdn.127.net/a95ff4aa99f013986f4b66be14b13fda.jpg",
          li: [
            "繁少了不够卖，繁多了卖不了",
        ...
        {
          src:
            "https://yanxuan.nosdn.127.net/a35af1269a889cec2070452bf9e2ef51.jpg",
          li: [
            "品牌传播体系未健全，品牌效应不足",
            "传统的营销方式，落后于信息时代的大潮流",
        ...
        {
          src:
            "https://yanxuan.nosdn.127.net/a0569800551976a84967fec385d0df64.jpg",
          li: [
            "销售成本居高不下，严重制约企业发展",
        ...
        {
          src:
            "https://yanxuan.nosdn.127.net/44bfaea8fcf72015434d6693c733e9e2.jpg",
          li: [
            "恶性竞争导致整个行业发展倒退",
            "企业求变，力量单一，不足以形成燎原之势",
      ...
      tabPane1: [
        "http://60.205.246.126/images/2020/10/20/1603155933081267.jpg",
        "http://60.205.246.126/images/2020/10/20/1603155960563300.jpg",
        "http://60.205.246.126/images/2020/10/20/1603156002482115.jpg",
        "http://60.205.246.126/images/2020/10/20/1603156033122068.jpg",
      ],
      bIcon: [
        {
          src:
