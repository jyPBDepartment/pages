<template>
  <div class="Home">
    ...
    <div class="banner-font" style>
      <h2 class="css2215ee06652225e">有效降低供应商销售成本</h2>
      <p class="css2215f1c4942225e">大数据辅助科学决策</p>
    </div>
    ...
    <Fast :title="modelName[1].title" :id="modelName[1].id">
      <el-row class="h_y">
        <el-col :span="12" class="text1">
          ...
          <p>大数据支撑决策，不再盲目生产</p>
          <p>通过支付订金的方式，提前锁定销售数量，杠杆效应助力</p>
        </el-col>
        <el-col :span="12">
          <img src="https://yanxuan.nosdn.127.net/8f0291a76b9bf43d0cd724291b426fef.png" alt />
        </el-col>
      </el-row>
    </Fast>
    <Fast :title="modelName[2].title" :id="modelName[2].id" background="#f6f7fc">
      <el-row class="b-b" type="flex" justify="center">
  ...
  data() {
    return {
      ...
      banner: [
        {
          src:
            "https://s1.ax1x.com/2020/07/24/UjPhw9.png"
        },
        {
          src:
            "https://s1.ax1x.com/2020/07/24/UjP4oR.png"
        }
      ],
      functionList: [
        {
      ...
      m_b_text: [
        "线上货品展示，不受人脉限制，轻松取得更多销量",
        "仅需网店运营人员，节省销售成本，提高利润率",
        "大数据支撑决策，不再盲目生产",
        "通过支付订金的方式，提前锁定销售数量，杠杆效应助力"
      ],
      bottonList: [
        {
          src:
