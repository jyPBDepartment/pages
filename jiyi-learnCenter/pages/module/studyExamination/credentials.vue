<template>
	<view class="content">
		...
		<view class="introduce">
			...
			<view class="subject">
				<view class="left">
					<u-steps :list="numList" :current="currentIndex" direction="column" mode="dot" active-color="#ffaa7f" class="steps"></u-steps>
				</view>
				<view class="right">
					<!--认证名额  -->
					<view class="one">
		...
		<view>
			<u-popup v-model="show" mode="center" width="620rpx" height="520rpx" :mask-close-able="false">
				<view>
					<view style="text-align: center;margin-top: 12rpx;">恭喜你晋级成功，请完善信息获取证书！</view>
					<view class="card-box" style="padding: 30rpx;margin: 30rpx 20rpx 20rpx 20rpx;">
						<u-row>
							...
							<u-col span="9">
								<u-input type="text" placeholder="输入姓名" :focus="true" v-model="name" height="64" maxlength="10" />
							</u-col>
						</u-row>
						<u-line></u-line>
						<u-row style="padding-top: 20rpx;">
							...
							<u-col span="9">
								<u-input type="text" placeholder="输入手机号" :focus="true" maxlength="11" v-model="phone" height="64" />
							</u-col>
						</u-row>
						<u-line></u-line>
						<u-line></u-line>
						<u-row style="padding-top: 20rpx;">
							...
							<u-col span="9">
								<u-input type="text" placeholder="输入身份证号" :focus="true" maxlength="18" v-model="idCard" height="64" />
							</u-col>
						</u-row>
						<u-line></u-line>
						<u-row style="margin-top: 24rpx;">
							<u-col :span="6">
								<u-button @click="applyCertificate()">提交</u-button>
