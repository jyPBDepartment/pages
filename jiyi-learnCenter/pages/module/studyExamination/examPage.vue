<template>
	<view class="content">
		...
		<view class="second">
			<view>
				<u-count-down
					...
					bg-color="#333"
					height="60"
					style="margin:10rpx 0 0 20rpx;"
					separator-color="#fff"
					@end="end"
				></u-count-down>
			</view>
			<view class="paging">{{ jumpCount }}/{{ examCount }}</view>
		</view>
		<view class="center" v-show="jumpCount == index1 + 1" v-for="(item1, index1) in examList" :key="index1">
			...
			<!-- 按钮 -->
			<view class="next">
				<button v-if="jumpCount != 1" type="info" @click="prefixQues(index1 + 1)" class="examBtn">上一题</button>
