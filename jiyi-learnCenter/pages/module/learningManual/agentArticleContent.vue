...
<script>
	export default {
		data() {
			return {
				articleList:[
					{title:"小孩子在很多时候比大人还爱面子，因为世界小，所以，所有的小事都不小。",read:"300",publicTime:"2020-02-19 12:23:46",readGuide:"记绾长条欲别难。盈盈自此隔银湾。便无风雪也摧残。青雀几时裁锦字，玉虫连夜剪春幡。不禁辛苦况相关。经销商。",url:"http://60.205.246.126:8001/images/2020/10/12/1602481725923183.jpg",articleContent:"故事的开始，总会有个人，故意选择隐匿他的过去，惟你，让我的回忆汹涌而平静。"}
				]
			}
		},
		methods:{
