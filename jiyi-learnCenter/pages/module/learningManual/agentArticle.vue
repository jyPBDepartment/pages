<template>
	<view class="content">
		...
		<!-- 搜索 -->
		<view class="select">
			<u-search placeholder="搜索标题或标签" bg-color="#fff" :show-action="false" input-align="left" maxlength="16" class="input"
			 v-model="title" @input="blurSearch"></u-search>
		</view>
	...
	export default {
		...
		methods: {
			...
			agentArticleJump(getId) {
				uni.navigateTo({
					url: './agentArticleContent?learningId=' + this.learningId + '&id=' + getId
				})
			},
			//搜索功能
			blurSearch() {
