...
<script>
	export default {
		data() {
			return {
				articleList:[
					{title:"去往麋鹿处，尽头是荒芜。",read:"300",publicTime:"2020-02-19 12:23:46",readGuide:"记绾长条欲别难。盈盈自此隔银湾。便无风雪也摧残。青雀几时裁锦字，玉虫连夜剪春幡。不禁辛苦况相关。热门课程。",url:"http://60.205.246.126:8001/images/2020/10/12/1602481877672647.jpg",articleContent:"人生若只如初见，何事秋风悲画扇？等闲变却故人心，却道故人心易变。骊山语罢清宵半，泪雨霖铃终不怨。何如薄幸锦衣郎，比翼连枝当日愿。春花春月年年客，怜春又怕春离别。只为晓风愁，催花扑玉钩。娟娟双蛱蝶，宛转飞花侧。花底一声歌，疼花花奈何。"}
				]
			}
		},
		methods:{
