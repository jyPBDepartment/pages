<template>
	<view id="main">
		...
		<header-box title="学习中心"></header-box>
		<!--  轮播图 -->
		...
		<!--  热门课程 -->
		<comm-title title="热门课程" @more="hyMore"></comm-title>
		...
		<view class="list card-box" v-for="(item, index) in hotCourseList" :key="index" @click="rmDetail(item.id, type)">
			<view class="listOne">
