...
<template>
  <div>
    ...
    >
      ...
      <el-table-column sortable prop="permissionName" label="权限名称" width="300"></el-table-column>
      <el-table-column sortable prop="permission" label="权限CODE" width="300"></el-table-column>
