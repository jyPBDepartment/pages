...
<template>
  <div>
    ...
    >
      ...
      <el-table-column sortable prop="machineNo" label="终端号" width="200"></el-table-column>
      <el-table-column sortable prop="payType" label="支付方式" width="200"></el-table-column>
      <el-table-column sortable prop="configName" label="显示名称" width="200"></el-table-column>
      <el-table-column sortable prop="payOpen" label="状态" width="200"></el-table-column>
      <el-table-column sortable prop="editTime" label="修改时间" width="200">
        <template slot-scope="scope">
          <div>{{scope.row.editTime|timestampToTime}}</div>
        </template>
      </el-table-column>
      <el-table-column sortable prop="editUser" label="修改人" width="150"></el-table-column>
