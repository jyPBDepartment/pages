  ...
  <div class="m-chat-editor" @click="hideRobotList">
    ...
    <div class="m-chat-editor-main" :class="{ robot: isRobot }">
      <span class="u-editor-input">
        ...
        ></textarea>
        <i
          v-if="supportTouch && !sendTxt"
          class="u-btn-record"
          :class="{ recording: recording, disabled: recordDisable }"
          @touchstart.prevent="toRecord"
          v-touch:swipeup="cancelRecord"
          @touchend.prevent="sendRecordMsg"
        >
        ...
        >
          ...
          <a
            v-if="recording"
            id="recordTime"
            class="u-record-time with-close-btn"
            @click.stop="cancelRecord"
            >00:00</a
          >
        </i>
      </span>
      <span class="u-editor-icons" style="margin-top: 1.3rem">
        ...
        <span
          v-if="!isRobot && !advancedTeam"
          class="u-editor-icon"
          @click.stop="sendPlayMsg"
        >
          <i class="u-icon-img"><img :src="icon3" /></i>
        </span>
        <span
          v-if="advancedTeam"
          class="u-editor-send u-editor-receipt"
          @click="turnToMsgReceipt"
          >回执</span
        >
    ...
    runRecorderTime() {
      if (this.recorder) {
        ...
        this.recordTimeout = setTimeout(
          this.runRecordDuration.bind(this),
          1000
        );
      }
    },
