  ...
  <view>
    ...
    <view class="p-x-10">
      ...
      <view class="g-flex p-y-10">
        ...
        <view class="title f-14" style="width: 140rpx"> 设置封面 </view>
        <view class="info g-f-1" style="position: relative">
          <u-upload
            :show-progress="false"
            :action="action"
      ...
      <view class="g-flex p-y-10 g-a-c">
        <span style="color: #ff0000">*</span>
        <view class="title f-14" style="width: 140rpx"> 粮食种类 </view>
        <view class="info g-f-1" style="position: relative">
          <u-input
            placeholder="请选择"
            v-model="transactionCategoryName"
            type="select"
            border
            @click="sexShow = true"
          />
