	...
	<view>
		...
		<view class="comm-form-container">
			<view class="item">
				...
				<view class="info"><u-input placeholder="输入内容(必填,不能超过10个汉字)" maxlength="10" :clearable="false" v-model="machine.name" /></view>
			</view>
			<view class="item">
			...
			<view class="item">
				<view class="title f-14">农机图片</view>
			...
			<view class="item">
				...
				<view class="info"><u-input placeholder="请输入联系人" :clearable="false" v-model="machine.contactsUser" /></view>
			</view>
			<view class="item">
				<view class="title">联系电话</view>
				<view class="info"><u-input placeholder="请输入联系电话" type="number" maxlength="11" :clearable="false" v-model="machine.contactsPhone" /></view>
			</view>
			<view class="item">
		...
		<u-calendar v-model="dateShow" @change="change" active-bg-color="#42b983" btn-type="success">
			<view slot="tooltip"><view class="t-c p-y-10" style="color: #2979FF">请选择购买时间</view></view>
		</u-calendar>
		<u-toast ref="uToast" />
	</view>
</template>
