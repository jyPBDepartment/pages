	...
	<view>
		...
		<view class="p-x-10">
			<view class="g-flex p-y-10 g-a-c" style="border-bottom: 1rpx solid #999;">
				...
				<view class="info g-f-1" style="position: relative;"><u-input placeholder="输入内容" :clearable="false" v-model="value" height="64" /></view>
			</view>
			...
			<view class="g-flex p-y-10">
				<view class="title f-14" style="width: 140rpx;">土地图片</view>
				<view class="info g-f-1" style="position: relative;">
			...
			<view class="g-flex p-y-10 g-a-c">
				<view class="title f-14" style="line-height: 62rpx; width: 140rpx;">交易类型</view>
				<view class="info g-f-1" style="position: relative;">
			...
			<view class="g-flex p-y-10 g-a-c">
				<view class="title f-14" style="width: 140rpx;">粮食类型</view>
				<view class=" info g-f-1" style="position: relative;">
			...
			<view class="g-flex p-y-10 g-a-c">
				<view class="title f-14" style=" width: 140rpx;">收购价格</view>
