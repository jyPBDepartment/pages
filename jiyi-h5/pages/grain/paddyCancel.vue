<template>
	<view class="g-flex g-f-column">
		...
		<view class="p-x-10 b-t">
			<view class="g-flex g-a-c p-y-10">
				<view class="title g-f-1 f-16" style="padding:0rpx;">{{ agriName }}</view>
			</view>

			<view class="price" style="font-size: 42rpx;margin-top: 16rpx;">￥{{ workPrice }}元/亩</view>

			<view class="info">
				<view class="info-item">
					<view class="f-12" style="color: #999999;margin-top: 24rpx;">日期：{{ beginDate }}至{{ endDate }}</view>
		...
		<view class="btn g-flex">
			...
			<view class="g-f-1"><u-button @click="cencal(true)" shape="circle">取消</u-button></view>
		</view>
		<CancelReason @confirm="confirm" :isShow="cencalIsShow" @isShow="cencal" v-model="reason" name="取消"></CancelReason>
	</view>
</template>
