				...
				<view class="item-info">
					...
					<view class="fun-btn">
						...
						<view class="item" @tap.stop="clickIcon('2',item)">
							<u-icon v-if="item.is_collection == null" style="margin-right: 5rpx;" name="http://60.205.246.126/images/2021/01/11/1610334200305905.png"
						...
						<view class="item" @tap.stop="clickIcon('1',item)">
							<u-icon v-if="item.is_praise == null" style="margin-right: 5rpx;" name="http://60.205.246.126/images/2021/01/11/1610333920310281.png"
							 color="#9FA3A8" size="24"></u-icon>
