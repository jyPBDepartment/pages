<template>
  <view>
    ...
    <view class="p-x-10">
      ...
      <view class="g-flex p-y-10 g-a-c">
        <view class="title f-14" style="width: 140rpx"> 机器类型 </view>
        <view class="info g-f-1" style="position: relative">
          <u-input
            placeholder="请选择"
            v-model="value"
      ...
      <view class="g-flex p-y-10 g-a-c">
        <view class="title f-14" style="width: 140rpx"> 机器型号 </view>
        <view class="info g-f-1" style="position: relative">
          <u-input
            placeholder="请输入机器型号"
            :clearable="false"
      ...
      <view class="g-flex p-y-10 g-a-c">
        <view class="title f-14" style="width: 140rpx"> 标签 </view>
        <view class="info g-f-1 g-flex g-j-s-b" style="position: relative">
          <view
            class="tag f-12 g-flex g-a-c g-j-c"
      ...
      <u-button style="margin: 40rpx" shape="circle" type="error"
        >发布</u-button
      >
    </view>
    <regionalComponents
      v-show="regionaStatus"
      ref="region"
      @cancel="cancel"
      @sure="sure"
    />
