  ...
  <view class="comment-details-container">
    ...
    <view class="comment-box-c">
      <view class="top-box-c">
        ...
        <text class="right" @tap="goCommentList(commentData.id)"
          >{{ totalElements ? "全部评论" : "去评论" }} ></text
        >
      </view>
...
export default {
  ...
  data() {
    return {
      ...
      style: {
        p:
          "word-wrap: break-word;word-break: break-all;overflow: hidden;color:#000000;font-size:28rpx;font-weight:blod;",
      },
      content: 121212121,
      commentList: [],
      totalElements: 0,
