<template>
	<view class="comment-details-container">
		...
		<view class="comment-content">
			...
			<view class="content">
				<u-parse :html="commentData.content" :tag-style="style"></u-parse>
			</view>
		</view>
		<view class="fun-btn">
			<view class="item">
				<u-icon style="margin-right: 5rpx;" name="http://60.205.246.126/images/2021/01/11/1610334104458166.png" color="#9FA3A8"
				 size="24"></u-icon>
				<text>{{ commentData.view_num }}</text>
			</view>
			<view class="item" @tap.stop="clickIcon('2',commentData)">
				<u-icon v-if="commentData.is_collection == null" style="margin-right: 5rpx;" name="http://60.205.246.126/images/2021/01/11/1610334200305905.png"
				 color="#9FA3A8" size="24"></u-icon>
				<u-icon v-else style="margin-right: 5rpx;" name="http://60.205.246.126/images/2021/01/11/1610334414334544.png"
				 color="#9FA3A8" size="24"></u-icon>
				<text>{{ commentData.collection_num }}</text>
			</view>
			<view class="item" @tap.stop="clickIcon('1',commentData)">
				<u-icon v-if="commentData.is_praise == null" style="margin-right: 5rpx;" name="http://60.205.246.126/images/2021/01/11/1610333920310281.png"
				 color="#9FA3A8" size="24"></u-icon>
				<u-icon v-else style="margin-right: 5rpx;" name="http://60.205.246.126/images/2021/01/11/1610335031904388.png"
				 color="#9FA3A8" size="24"></u-icon>
...
<script>
	...
	export default {
		...
		methods: {
			goCommentList(val){
				uni.navigateTo({
					url:'/pages/commentList/commentList?id='+val
				})
			},
			clickIcon(m, n) {
				// 执行收藏方法
