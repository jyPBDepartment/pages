	...
	<view>
		...
		<view class="comm-form-container">
			<view class="item">
				...
				<view class="info"><u-input placeholder="输入内容(最多输入10字)" :clearable="false" v-model="agr.name" maxlength="10" /></view>
			</view>
			<view class="item">
			...
			<view class="item">
				...
				<view class="info"><u-input placeholder="请输入农机台数" :clearable="false" v-model="agr.machineNum" maxlength="10" /></view>
			</view>
			<view class="item">
				<view class="title">价格</view>
				<u-row :gutter="6">
					<u-col>
						<view class="info" style="position: relative;margin-bottom: 10rpx;">
							<u-radio-group :size="30" v-model="agr.isFace" @change="radioGroupChange1">
			...
			<view class="item">
				...
				<view class="info">
					<u-radio-group :size="30" v-model="agr.farmingMode" @change="radioGroupChange">
			...
			<view class="item">
				...
				<view class="info"><u-input placeholder="请输入联系人" :clearable="false" v-model="agr.contactsUser" /></view>
			</view>
			<view class="item">
				<view class="title">联系电话</view>
				<view class="info"><u-input type="number" maxlength="11" placeholder="请输入联系电话,仅限数字" :clearable="false" v-model="agr.contactsPhone" /></view>
			</view>
			<view class="item">
				<view class="title">区域</view>
				<view class="info"><u-input placeholder="请选择" v-model="agr.address" type="select" @click="regionaStatus = true" /></view>
			</view>
