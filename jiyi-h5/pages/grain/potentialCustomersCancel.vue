<template>
	<view class="g-flex g-f-column">
		...
		<view class="p-x-10">
			<view class="tips f-12" style="color: #e51c2e;line-height: 60rpx;">客户取消理由：{{ farmwork.reason }}</view>
			<view class="g-flex p-y-10 g-a-c">
				<view class="title f-14" style="width: 140rpx;">干活时间</view>
				<view class="info g-f-1 f-14" style="position: relative;">{{ farmwork.beginDate }}至{{ farmwork.endDate }}</view>
			</view>
			<view class="g-flex p-y-10 g-a-c">
				<view class="title f-14" style=" width: 140rpx;">面积</view>
				<view class="info g-f-1 f-14" style="position: relative;">{{ farmwork.area }}亩</view>
			</view>

			<view class="g-flex p-y-10 g-a-c">
				<view class="title f-14" style=" width: 140rpx;">干活地点</view>
				<view class=" info g-f-1 f-14" style="position: relative;">{{ farmwork.workArea }}</view>
			</view>
			<view class="g-flex p-y-10 g-a-c">
				<view class="title f-14" style=" width: 140rpx;">农活价格</view>
				<view class="info g-f-1 f-14" style="position: relative;">{{ farmwork.workPrice }}元</view>
			</view>
			<view class="g-flex p-y-10 g-a-c">
