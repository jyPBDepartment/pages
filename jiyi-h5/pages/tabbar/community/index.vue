  ...
  <view>
    ...
    <view class="tabs g-flex g-j-s-a g-a-c f-14">
      <view
        ...
        :class="index == tabIndex && 'tab-hover'"
      ...
      <view class="content">
        <view class="header">
          <image
            ...
            :src="
              item.header ||
              'http://60.205.246.126/images/2021/01/15/1610696168592617.png'
            "
          ></image>
          <text class="users">{{
            item.isAnonymous ? "匿名" : item.nickName ? item.nickName : "匿名"
          }}</text>
          <text class="times">{{
        ...
        <view v-if="item.picture"
          ><communituPicList :picList="item.picture"></communituPicList
        ></view>
        <view class="fun-btn">
          <view class="item">
            <u-icon
    ...
    <uni-drawer ref="drawer" mode="right" :width="300" :visible="true">
      <view style="padding: 20rpx">
        <view class="f-16" style="line-height: 52rpx; margin-bottom: 20rpx"
          >筛选类别</view
        >
        ...
        .then((res) => {
          if (res.code == 200) {
            if (item.isUserCollection == 1) {
              this.dataList[i].collectionNum =
                parseInt(this.dataList[i].collectionNum) - 1;
        ...
        .then((res) => {
          if (res.code == 200) {
            if (item.isUserPraise == 1) {
              this.dataList[i].praiseNum =
                parseInt(this.dataList[i].praiseNum) - 1;
