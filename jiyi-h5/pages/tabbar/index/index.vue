    ...
    <view class="content">
      ...
      <view class="appointment comm-border">
        ...
        <view class="preview">
          <view
            v-if="!nfList.length"
            style="width: 100%; line-height: 140rpx"
            class="f-16 t-c"
            >暂无数据</view
          >
          <view
            class="buju"
            @click="detailsNf(item.id)"
      ...
      <view class="appointment comm-border">
        ...
        <view class="preview">
          ...
          >
            ...
            <p
              class="text f-12 o-e"
              style="line-height: 32rpx; margin-top: 20rpx"
            >
              {{ item.name }}
            </p>
          </view>
        ...
        <view class="preview">
          ...
          >
            <view class="img">
              <view
                class="tag f-12 t-c"
                :style="{ 'background-color': item.bgColorTag }"
                >{{ item.transactionTypeCode }}</view
              >
              <image class="preview-img" :src="item.url" mode=""></image>
            </view>
            <p
